...
def test_spare():
    result = play_bowling(current_score = 0, rolls = 1, pins = 3)
    result = play_bowling(current_score = result, rolls = 1, pins = 7)
    result = play_bowling(current_score = result, rolls = 18, pins = 1)
    assert result == 29